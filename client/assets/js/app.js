(function() {
  ...
  angular.module('application', [
    ...
    .controller('Controller3', function Controller3($scope) {
      $scope.artist = [
        {
    ...
    Controller4.$inject = ['$scope', '$stateParams', '$state', '$controller', '$http'];

    function Controller4($scope, $stateParams, $state, $controller, $http) {
    ...
    Controller5.$inject = ['$scope', '$stateParams', '$state', '$controller', '$http'];

    function Controller5($scope, $stateParams, $state, $controller, $http) {
      angular.extend(this, $controller('DefaultController', {$scope: $scope, $stateParams: $stateParams, $state: $state, $http: $http}));
    ...
    Controller6.$inject = ['$scope', '$stateParams', '$state', '$controller', '$http'];

    function Controller6($scope, $stateParams, $state, $controller, $http) {
      angular.extend(this, $controller('DefaultController', {$scope: $scope, $stateParams: $stateParams, $state: $state, $http: $http}));
